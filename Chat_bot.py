...
with st.sidebar:
    ...
    selected_model = st.sidebar.selectbox('Choose a Large Langugae model', ['Phi 3 (Mini)','Gemini by Google', 'Llama3 8B Parameter by Meta'], key='selected_model')
